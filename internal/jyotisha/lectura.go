...
var es = tabla{
	...
	frases: map[string]string{
		...
		"pr_lagnaJoven":    "El lagna está en los tres primeros grados de su rāśi: el asunto acaba de arrancar y todavía no hay nada que juzgar.",
		"pr_lagnaViejo":    "El lagna está en los tres últimos grados de su rāśi: el asunto ya se ha resuelto, con o sin la pregunta.",
		"pr_lagnaGandanta": "El lagna cae en gaṇḍānta, el nudo entre agua y fuego. No se juzga desde ahí.",
		"pr_lunaGandanta":  "La Luna está en gaṇḍānta. La Luna es la mente del que pregunta, así que la pregunta sale de un nudo y no de una duda.",
		"pr_lunaDuhsthana": "La Luna está en el bhāva %d, que es una casa difícil. No invalida la pregunta, pero conviene decirlo: quien pregunta no está sereno.",
		"pr_bhava":         "El asunto se juzga por el bhāva %d, el de %s.",
		"pr_senor":         "Su señor, %[2]s, está en el bhāva %[3]d — o sea que lo preguntado pasa por %[4]s.",
		"pr_ocupanBien":    "Lo ocupan benéficos: %s. Eso favorece.",
		"pr_ocupanMal":     "Lo ocupan maléficos: %s. Eso aprieta, y lo que aprieta también obliga a trabajar.",
		"pr_vacio":         "El bhāva está vacío, que es lo corriente. Se lee por su señor, no por lo que hay dentro.",
		"pr_guruMira":      "Júpiter lo mira. Es la mejor señal que da el sistema: basta para salvar una casa afligida.",
		"pr_mismoSenor":    "El señor del lagna y el del asunto son el mismo graha: el que pregunta y lo preguntado son la misma cosa.",
		"pr_juntos":        "%s y %s están juntos en un mismo rāśi: el que pregunta y lo preguntado están enlazados, y el asunto avanza.",
		"pr_seMiran":       "%s y %s se miran mutuamente: hay conexión, aunque no inmediata.",
		"pr_sinRelacion":   "%s y %s ni se juntan ni se miran: el asunto no está en manos del que pregunta, o no ahora.",
		"pr_savAlto":       "El aṣṭakavarga de ese rāśi da %d bindus, por encima de la media de 28. La casa tiene apoyo.",
		"pr_savBajo":       "El aṣṭakavarga de ese rāśi da %d bindus, por debajo de 25. La casa va escasa de apoyo.",
		"pr_savMedio":      "El aṣṭakavarga de ese rāśi da %d bindus, en la media. Ni empuja ni estorba.",
		"pr_nota":          "Un praśna no adivina: mide cómo está el asunto en el instante en que se pregunta. Y no fecha sucesos — la regla del módulo 13 vale aquí entera. Si la pregunta sale como no apta, esa ES la respuesta: se espera y se vuelve a preguntar.",
...
var en = tabla{
	...
	frases: map[string]string{
		...
		"pr_lagnaJoven":    "The lagna sits in the first three degrees of its rāśi: the matter has only just started and there is nothing to judge yet.",
		"pr_lagnaViejo":    "The lagna sits in the last three degrees of its rāśi: the matter has already resolved itself, with or without the question.",
		"pr_lagnaGandanta": "The lagna falls in gaṇḍānta, the knot between water and fire. Nothing is judged from there.",
		"pr_lunaGandanta":  "The Moon is in gaṇḍānta. The Moon is the mind of the one asking, so the question comes out of a knot and not out of a doubt.",
		"pr_lunaDuhsthana": "The Moon is in bhāva %d, a difficult house. It does not invalidate the question, but it is worth saying: whoever is asking is not settled.",
		"pr_bhava":         "The matter is judged by bhāva %d, the one for %s.",
		"pr_senor":         "Its lord, %[2]s, is in bhāva %[3]d — so what is asked passes through %[4]s.",
		"pr_ocupanBien":    "Benefics occupy it: %s. That helps.",
		"pr_ocupanMal":     "Malefics occupy it: %s. That presses, and what presses also forces work.",
		"pr_vacio":         "The bhāva is empty, which is the usual case. It is read through its lord, not through what sits inside.",
		"pr_guruMira":      "Jupiter looks at it. It is the best sign the system gives: enough to save an afflicted house.",
		"pr_mismoSenor":    "The lord of the lagna and the lord of the matter are the same graha: the one asking and the thing asked about are one and the same.",
		"pr_juntos":        "%s and %s sit together in one rāśi: the one asking and the thing asked about are linked, and the matter moves.",
		"pr_seMiran":       "%s and %s look at each other: there is a connection, though not an immediate one.",
		"pr_sinRelacion":   "%s and %s neither join nor look at each other: the matter is not in the hands of the one asking, or not now.",
		"pr_savAlto":       "The aṣṭakavarga of that rāśi gives %d bindus, above the average of 28. The house has support.",
		"pr_savBajo":       "The aṣṭakavarga of that rāśi gives %d bindus, below 25. The house is short of support.",
		"pr_savMedio":      "The aṣṭakavarga of that rāśi gives %d bindus, right at the average. It neither pushes nor hinders.",
		"pr_nota":          "A praśna does not divine: it measures how a matter stands at the instant it is asked. And it does not date events — the rule of module 13 applies here in full. If the question comes out unfit to judge, that IS the answer: wait and ask again.",
